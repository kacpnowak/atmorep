...
from atmorep.utils.utils import days_until_month_in_year, days_in_month


####################################################################################################

def netcdf_file_loader(fname, field, time_padding=[0, 0, 1], fesom=0, static=False):
    ds = xr.open_dataset(fname, engine='netcdf4')[field]
    # In case of FESOM data fesom argument is used to pass (year, month, level) tuple
